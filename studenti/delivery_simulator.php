...
<body>
    ...
    <main class="landing-content">
        ...
        <p>Alegeți orașul de plecare și destinația pentru a obține o estimare de cost logistic bazată pe parametrii flotei.</p>
        ...
        <section class="delivery-simulator">
            ...
            <div class="simulator-form-container">
                <form id="delivery-form">
                    ...
                    <input type="number" id="greutate-colet" placeholder="Greutate Colet (kg, max 20)" min="0.1" max="20" step="0.1" required>
                    
                    <button type="submit">Calculează Cost</button>
                </form>

                <div id="rezultat-simulare" class="result-box">
                    <i class="fas fa-info-circle"></i> Vă rugăm introduceți datele de livrare pentru a obține o estimare de cost.
                </div>
            </div>
        </section>
