...
<body class="dashboard-layout">
    ...
    <div class="top-bar-dashboard">
        ...
        <nav>
            <ul class="dashboard-nav-links">
                ...
                <?php if ($role === 'admin' || $role === 'operator'): ?>
                    <li><a href="missions.php"><i class="fas fa-route"></i>
                            <?= $role === 'admin' ? 'Misiuni' : 'Cererile Mele' ?></a></li>
                <?php endif; ?>
        ...
        <div class="user-controls-top">
            <div class="user-info-top"><i class="fas fa-user-circle"></i> <?= htmlspecialchars($_SESSION['fullname']) ?>
            </div> <a href="logout.php" class="logout-top-button">Deconectare</a>
        </div>
    </div>
                ...
                <tbody>
                    <?php foreach ($historyLogs as $log): ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($log['TechName']): ?>
                                    <span class="badge-tech"><i class="fas fa-user-wrench"></i>
                                        <?= htmlspecialchars($log['TechName']) ?></span>
                                <?php else: ?>
                                    -
                                <?php endif; ?>
                            </td>
